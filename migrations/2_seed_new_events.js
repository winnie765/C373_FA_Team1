...
module.exports = async function (deployer, network, accounts) {
  // Use provided seller or fallback to deployer/owner
  ...
  // Ensure ABC event (matches events.json id 5 -> chain id 4)
  await ensureEvent({
    title: "ABC",
    ticketTypes: [
      {
  ...
  // Optional: ensure KPOP Night too (matches events.json id 4 -> chain id 3)
  await ensureEvent({
    title: "KPOP NIght",
    ticketTypes: [
      {
